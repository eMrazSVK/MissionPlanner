...
{
    public const string MAVLINK_BUILD_DATE = "Mon Feb 12 2018";
    ...
    public static readonly message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
		...
		new message_info(237, "ADB_ESC_DATA", 150, 37, 37, typeof( mavlink_adb_esc_data_t )),
...
AOA_SSA = 11020,
    ...
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=37)]
    ///<summary> DATA from ADB ESC </summary>
    public struct mavlink_adb_esc_data_t
    {
        /// <summary> Timestamp (milliseconds since system boot) </summary>
        public  uint time_boot_ms;
            /// <summary> esc speed </summary>
        public  float speed;
            /// <summary> esc Vs </summary>
        public  float vs;
            /// <summary> esc Is </summary>
        public  float Iss;
            /// <summary> esc Vbus </summary>
        public  float vbus;
            /// <summary> esc PWM </summary>
        public  uint pwm;
            /// <summary> esc temp </summary>
        public  uint temp;
            /// <summary> damaged packets </summary>
        public  uint damaged_msgs;
            /// <summary> good packets </summary>
        public  uint good_msgs;
